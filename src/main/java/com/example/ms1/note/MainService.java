...
//        List<Notebook> notebookList = notebookService.getNotebookList(); // 전체 노트북 리스트
        ...
        SearchDataDto searchDataDto = getSearchData(keyword);
    ...
    public SearchDataDto getSearchData(String keyword) {
        SearchDataDto searchDataDto = new SearchDataDto();
        searchDataDto.setSearchedNoteList(noteService.convertToDtoList(noteService.getSearchedNoteList(keyword)));
        searchDataDto.setSearchedNotebookList(notebookService.convertToDtoList(notebookService.getSearchedNotebookList(keyword)));
